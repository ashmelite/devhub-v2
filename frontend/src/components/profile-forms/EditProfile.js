...
import { Link, withRouter } from 'react-router-dom';    //withRouter is related to history object; see Profile actions
  ...
  return(
    <Fragment>
      ...
      <form className="form" onSubmit={e => onSubmit(e)} >
        ...
        <div>
          <button className="btn btn-light" type="button" onClick={() => toggleSocialInputs(!displaySocialInputs)} >
...
export default connect(mapStateToProps, { createProfile, getCurrentProfile })(withRouter(EditProfile));         //wrapping component with withRouter allows us to bring history object as props in CreateProfile