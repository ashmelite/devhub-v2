          ...
          <div>
            ...
            {showActions && 
              <Fragment>
                ...
                {!auth.loading && user === auth.user._id && (           //if post user and logged in user is same, show del button
...
export default connect(mapStateToProps, { addLike, removeLike, deletePost })(PostItem)       //we need auth state from mapStateToProps in order for user to delete their posts if they're logged in
